        ...
        if(user){
            ...
            try {
                ...
                const student = await new Student({
                    ...
                    mname: '-', mphone: '-', memail: '-', fname: '-', fphone: '-', femail: '-', class: '-', exams: [], educationalInfo: [{ type: "Current Degree", insName: "-", year: "-" , degree: "-", branch: "-", division: "-", semester: 0,batch:'-' , admissionYear: 0, score: "0" }, { type: "Junior College", insName: "-", degree: "-", passingYear: 0, score: "0" }, { type: "School", insName: "-", degree: "-", passingYear: 0, score: "0" }], semester: [{semesterNumber:1,courses:[],sgpa:0,academicYear:0,status:"Ongoing"},{semesterNumber:2,courses:[],sgpa:0,academicYear:0,status:"Not Started"},{semesterNumber:3,courses:[],sgpa:0,academicYear:0,status:"Not Started"},{semesterNumber:4,courses:[],sgpa:0,academicYear:0,status:"Not Started"},{semesterNumber:5,courses:[],sgpa:0,academicYear:0,status:"Not Started"},{semesterNumber:6,courses:[],sgpa:0,academicYear:0,status:"Not Started"},{semesterNumber:7,courses:[],sgpa:0,academicYear:0,status:"Not Started"},{semesterNumber:8,courses:[],sgpa:0,academicYear:0,status:"Not Started"},], committee: [], participation: [], volunteerWork: [],
