      ...
      >
        ...
        <div>
          ...
          <table>
            <thead>
              <th colSpan={7} className="table-heading">
                AP3:Lecture target achieved. Average for all the courses taught
              ...
              {history.Dimension1.AP6.menteeFeedback.map((mf, index) => {
                return (
                  <tr key={index}>
                    ...
                    {index === 0 && (
                      <td
                        rowSpan={history.Dimension1.AP6.menteeFeedback.length}
                      >
          ...
          <table className="page-break">
            <thead>
              <th colSpan={5} className="table-heading">
                AP7:Arrange Guest Lectures / co-teaching from industry (eminent
                resource person from the respective domain industry)
              </th>
            </thead>
            <thead>
              <tr>
                ...
                <th>Date</th>
                <th>
                  Sr. No. Date Title of the Guest Lecture Name &<br></br>{" "}
                  details of the Speaker Arranged for students/faculty
                </th>
          ...
          <table>
            ...
            <thead>
              <tr>
                ...
                <th>Sr. No. Paper Set for the Course Marks in audit report</th>
              </tr>
            </thead>
            <tbody>
        ...
        <table>
          ...
          <thead>
            <tr>
              <th>
                Sr. No. Number of citations in the previous calendar year * 0.4
                Marks
              </th>
              <th>Marks</th>
            </tr>
        ...
        <table>
          <thead>
            <th colSpan={5} className="table-heading">
              Invited as visiting /Guest faculty for delivering a course in
              industry/ institute
            </th>
          </thead>
          <thead>
        ...
        <table>
          <thead>
            <th colSpan={5} className="table-heading">
              Part of selection committee / inquiry/ academic audit / examiner
              panel/ BOS /AC/LIC/ RRC meetings/ external Auditor
            </th>
          </thead>
          <thead>
            <tr>
        ...
        <table>
          <thead>
            <th colSpan={3} className="table-heading">
              Co-guide for student projects and dissertations in the peer
              institutions
            </th>
          </thead>
          <thead>
